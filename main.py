...
def attack(char_name: str, char_class: str) -> str:
    """Определяет величину нанесённого урона."""
...
def defence(char_name: str, char_class: str) -> str:
    """Определяет величину заблокированного урона."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Позволяет использовать специальное умение."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Вызывает меню выбора класса персонажа."""
    approve_choice: str = ''
    char_class: str = ''
